...
Aircraft.Certification.Aerodynamic_data.Horizontal_Tail_Normal_Force_Curve_Slope.value = rad2deg(0.083)*1.0;
Aircraft.Certification.Aerodynamic_data.Horizontal_Tail_Normal_Force_Curve_Slope.Attributes.unit = "1/rad";
...
Aircraft.Geometry.Horizontal.b.value           = NaN; % 0.748;
...
Aircraft.Geometry.Horizontal.DepsilonDalpha.value = 0.3;
Aircraft.Geometry.Horizontal.DepsilonDalpha.Attributes.unit = "Non dimensional";
% -------------------------------------------------------------------------
% Engine
% -------------------------------------------------------------------------
...
fprintf('\n');
fprintf("--------------------------------------"); 
Aircraft.Certification.ISA_Condition.rho0.value = NaN;
Aircraft.Certification.ISA_Condition.rho0.Attributes.unit = 'kg/m^3';
Aircraft.Certification.ISA_Condition.Altitude.value = h;
Aircraft.Certification.ISA_Condition.Altitude.Attributes.unit = 'm';
Aircraft.Certification.ISA_Condition.rho.value = rho;
Aircraft.Certification.ISA_Condition.rho.Attributes.unit = "kg/m^3";
Aircraft.Certification.ISA_Condition.T.value = T; 
Aircraft.Certification.ISA_Condition.T.Attributes.unit = 'K'; 
Aircraft.Certification.ISA_Condition.p.value = p; 
Aircraft.Certification.ISA_Condition.p.Attributes.unit = 'Pa';
Aircraft.Certification.ISA_Condition.Speed_of_sound.value = acc; 
Aircraft.Certification.ISA_Condition.Speed_of_sound.Attributes.unit = 'm/s';
% -------------------------------------------------------------------------
