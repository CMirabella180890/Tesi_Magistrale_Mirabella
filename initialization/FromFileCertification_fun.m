...
VarText={'Aircraft.Certification.Aircraft_Name.value', ...
         ...
         'Aircraft.Certification.Performance.I_Level.Wing_loading_SI', ...
...
if LengthIndex==length(VarText)
    ...
    p = strcmp('Aircraft.Certification.Performance.I_Level.Wing_loading_SI',label);
    ...
    Aircraft.Geometry.Horizontal.Movable.eta_inner.value = str2double(table2array(value(p==1, 1)));
    Aircraft.Geometry.Horizontal.Movable.eta_inner.Attributes.unit = char(table2array(unit(p==1,1)));
    p = strcmp('Aircraft.Geometry.Horizontal.Movable.eta_outer', label);
    Aircraft.Geometry.Horizontal.Movable.eta_outer.value = str2double(table2array(value(p==1, 1)));
    Aircraft.Geometry.Horizontal.Movable.eta_outer.Attributes.unit = char(table2array(unit(p==1,1)));
    p = strcmp('Aircraft.Geometry.Horizontal.Movable.cf_c_inner', label);
    Aircraft.Geometry.Horizontal.Movable.cf_c_inner.value = str2double(table2array(value(p==1, 1)));
    Aircraft.Geometry.Horizontal.Movable.cf_c_inner.Attributes.unit = char(table2array(unit(p==1,1)));
    p = strcmp('Aircraft.Geometry.Horizontal.Movable.cf_c_outer', label);
    Aircraft.Geometry.Horizontal.Movable.cf_c_outer.value = str2double(table2array(value(p==1, 1)));
    Aircraft.Geometry.Horizontal.Movable.cf_c_outer.Attributes.unit = char(table2array(unit(p==1,1)));
