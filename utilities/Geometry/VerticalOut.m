...
%             % TECNAM P92
            plot([xtip_le_h*lf, xtip_le_h*lf+Aircraft.Geometry.Vertical.croot.value],...
                [zvloc, zvloc],'y',"LineWidth",1.5)
            plot([xtip_le_v*lf+2*Aircraft.Geometry.Vertical.ctip.value, xtip_le_v*lf+3*Aircraft.Geometry.Vertical.ctip.value],...
                [zvloc + Aircraft.Geometry.Vertical.b.value, zvloc + Aircraft.Geometry.Vertical.b.value],'y',"LineWidth",1.5)
            plot([xtip_le_h*lf, xtip_le_v*lf+2*Aircraft.Geometry.Vertical.ctip.value],...
                [zvloc, zvloc + Aircraft.Geometry.Vertical.b.value],'y',"LineWidth",1.5)
            plot([xtip_le_h*lf+Aircraft.Geometry.Vertical.croot.value, xtip_le_v*lf+3*Aircraft.Geometry.Vertical.ctip.value],...
                [zvloc, zvloc + Aircraft.Geometry.Vertical.b.value],'y',"LineWidth",1.5)
...
% TECNAM P92
    plot([xle_inner+0.1  xle_inner+cf_inner+0.05],...
        zvloc + [y_inner y_inner],'y',"LineWidth",1.5)
    plot([xle_outer+0.35 xle_outer+cf_outer+0.35],...
        zvloc + [y_outer y_outer],'y',"LineWidth",1.5)
    plot([xle_inner+0.3 xle_outer+0.35],...
        zvloc + [y_inner y_outer],'y',"LineWidth",1.5)

    fill ([xle_inner+0.1 xle_outer+0.35 xle_outer+cf_outer+0.35 xle_inner+cf_inner+0.05],...
