...
%             plot([xtip_le_h*lf, xtip_le_h*lf+Aircraft.Geometry.Vertical.croot.value],...
%                 [zvloc, zvloc],'y',"LineWidth",1.5)
%             plot([xtip_le_v*lf+0.44, xtip_le_v*lf+Aircraft.Geometry.Vertical.ctip.value+0.44],...
%                 [zvloc + Aircraft.Geometry.Vertical.b.value, zvloc + Aircraft.Geometry.Vertical.b.value],'y',"LineWidth",1.5)
%             plot([xtip_le_h*lf, xtip_le_v*lf+0.44],...
%                 [zvloc, zvloc + Aircraft.Geometry.Vertical.b.value],'y',"LineWidth",1.5)
%             plot([xtip_le_h*lf+Aircraft.Geometry.Vertical.croot.value, xtip_le_v*lf+Aircraft.Geometry.Vertical.ctip.value+0.44],...
%                 [zvloc, zvloc + Aircraft.Geometry.Vertical.b.value],'y',"LineWidth",1.5)
...
% TECNAM P92
%     plot([xle_inner  xle_inner+cf_inner+0.02],...
%         zvloc + [y_inner y_inner]-0.12,'y',"LineWidth",1.5)
%     plot([xle_outer+0.16 xle_outer+cf_outer+0.19],...
%         zvloc + [y_outer y_outer],'y',"LineWidth",1.5)
%     plot([xle_inner xle_outer+cf_outer-cf_outer+0.16],...
%         zvloc + [y_inner-0.12 y_outer],'y',"LineWidth",1.5)
%     
%     fill ([xle_inner xle_outer+cf_outer-cf_outer+0.16 xle_outer+cf_outer+0.19 xle_inner+cf_inner+0.03],...
%         [zvloc + y_inner-0.12  zvloc + y_outer...
%         zvloc + y_outer  zvloc + y_inner-0.12],'y')

    plot([xle_inner  xle_inner+cf_inner],...
        zvloc + [y_inner y_inner],'y',"LineWidth",1.5)
    plot([xle_outer xle_outer+cf_outer],...
        zvloc + [y_outer y_outer],'y',"LineWidth",1.5)
    plot([xle_inner xle_outer+cf_outer-cf_outer],...
        zvloc + [y_inner y_outer],'y',"LineWidth",1.5)
    
    fill ([xle_inner xle_outer+cf_outer-cf_outer xle_outer+cf_outer xle_inner+cf_inner],...
