...
str = ['The asymmetric flow through the propeller disc is discounted ' ...
    ...
    (' ') ...
    strcat(num2str(Aircraft.Propeller.Propeller_polar_moment.value)) ...
    (' ') ...
    ...
    (' ') ...
    strcat(num2str(Engine_normal_load_factor)) ...
    ...
    ' = ' ...
    (' ') ...
    strcat(num2str(Engine_gyro_inertia_load)) ...
    (' ') ...
    char(Aircraft.Certification.Regulation.SubpartC.Flightloads.Engine_loads.Inertia_load_on_engine_mount.Attributes.unit) ...
    '. The rotation of the propeller at maximum continuous power is ' ...
    (' ') ...
    strcat(num2str(Aircraft.Engine.Max_Continous.RPM.value)) ...
    '/' ...
    strcat(num2str(reduction_ratio)) ...
    ' = ' ...
...
add(sec,para);    
        ...
        ref1 = ['Yaw case: ' ...
            ...
            strcat(num2str(Aircraft.Engine.Max_Continous.Propeller_rotational_speed.value)) ...
            ' = ' ...
            strcat(num2str(Aircraft.Certification.Regulation.SubpartC.Flightloads.Engine_loads.Gyroscopic_loads.yaw_case.value)) ...
            (' ') ...
        ...
        ref2 = ['Pitch case: ' ...
            ...
            strcat(num2str(Aircraft.Engine.Max_Continous.Propeller_rotational_speed.value)) ...
            ' = ' ...
            strcat(num2str(Aircraft.Certification.Regulation.SubpartC.Flightloads.Engine_loads.Gyroscopic_loads.pitch_case.value)) ...
            (' ') ...
