    ...
    case 'Case 1'
        ...
        for i = 1:length(V_from0toS)
            ...
            while abs(CL_wb - CL_tail) > tol
               alfa_new_from0toS = alpha_fullmodel(CL_new_from0toS, a2, b2, c2, CL_max_wingbody, CL_star, CL0, CLalfa);
...
%             % ---------------------------------------------------------------------
            ...
            Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.CL_S_new.value = CL_fullmodel(alfaS_new);
            ...
            Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA1.CL_A1_new.value = CL_fullmodel(alfaA1_new);
            ...
            Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC1.CL_C1_new.value = CL_fullmodel(alfaC1_new);
            ...
            Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.CL_C_new.value = CL_fullmodel(alfaC_new);
            ...
            Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC2.CL_C2_new.value = CL_fullmodel(alfaC2_new);
            ...
            Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.CL_D_new.value = CL_fullmodel(alfaD_new);
