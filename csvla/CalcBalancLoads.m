...
% *** From point C to point D ***
CD_fromCtoD = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.Positive_stall_speed.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.Positive_stall_speed.value)
    CD_fromCtoD(i) = cd_calc(obj1, Aircraft.Certification.Aerodynamic_data.CD0.value, ...
                             Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value(i), ...
                             Aircraft.Geometry.Wing.AR.value, ...
                             Aircraft.Certification.Aerodynamic_data.e.value, ...
                             Aircraft.Certification.Aerodynamic_data.Pol_coeff_k1.value, ...
                             Aircraft.Certification.Aerodynamic_data.Pol_coeff_k2.value);
...
%                                         Aircraft.Certification.Aerodynamic_data.CL0.value, ...
%                                         Aircraft.Certification.Aerodynamic_data.Normal_Force_Curve_Slope_deg.value);
      alpha_fromCtoD = alpha_calc(obj1, ...
                                       Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value, ...
                                       Aircraft.Certification.Aerodynamic_data.CL0.value, ...
                                       Aircraft.Certification.Aerodynamic_data.CL_star.value, ...
                                       Aircraft.Certification.Aerodynamic_data.Normal_Force_Curve_Slope_deg.value, ...
                                       p);
...
% Alpha from C to D
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD.value = alpha_fromCtoD;
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD.Attributes.unit = "Degrees";
...
% *************************************************************************
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD_rad.value                = deg2rad(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD.value);
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD_rad.Attributes.unit      = "Radians";
% -------------------------------------------------------------------------
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WBLift_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value)   
    V = V_fromCtoD(i);
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WBLift_fromCtoD.value(i) = (0.5)*(V^2)* ...
        (Aircraft.Geometry.Wing.S.value)*(Aircraft.Certification.ISA_Condition.rho.value)*(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value(i))*(1E-1);   
end
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CLwb_pitch_contrib_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value)
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CLwb_pitch_contrib_fromCtoD.value(i) = CLWB_contrib(obj1, Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value(i), ...
                   Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD_rad.value(i), ...
                   Aircraft.Certification.Aerodynamic_data.XAC_nondim.value, ... 
                   Aircraft.Certification.Aerodynamic_data.XCG_nondim.value, ...
                   Aircraft.Certification.Aerodynamic_data.bcg.value, ...
                   Aircraft.Geometry.Wing.mac.value);
end
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CLwb_pitch_contrib_fromCtoD.Attributes.unit = "Non dimensional";
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CDwb_pitch_contrib_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CD_fromCtoD.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CD_fromCtoD.value)
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CDwb_pitch_contrib_fromCtoD.value(i) = CDWB_contrib(obj1, Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CD_fromCtoD.value(i), ...
                   Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD_rad.value(i), ...
                   Aircraft.Certification.Aerodynamic_data.XAC_nondim.value, ... 
                   Aircraft.Certification.Aerodynamic_data.XCG_nondim.value, ...
                   Aircraft.Certification.Aerodynamic_data.bcg.value, ...
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CDwb_pitch_contrib_fromCtoD.Attributes.unit = "Non dimensional";
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CTwb_pitch_contrib_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CD_fromCtoD.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CD_fromCtoD.value)
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CTwb_pitch_contrib_fromCtoD.value(i) = CT_contr(obj1, Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CD_fromCtoD.value(i), ...
                   Aircraft.Geometry.Engine.Primary.Thrust_axes.value, ...
                   Aircraft.Geometry.Wing.mac.value);
end
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CTwb_pitch_contrib_fromCtoD.Attributes.unit = "Non dimensional";
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CMwb_pitch_contrib_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value)
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CMwb_pitch_contrib_fromCtoD.value(i) = CM_aboutcg(obj1, ...
                                                                                            Aircraft.Certification.Aerodynamic_data.CM0.value, ...
                                                                                            Aircraft.Certification.Aerodynamic_data.CM_landing_gear.value, ...
                                                                                            Aircraft.Certification.Aerodynamic_data.CMCL.value, ...
                                                                                            Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value(i));
end
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CMwb_pitch_contrib_fromCtoD.Attributes.unit = "Non dimensional";
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD_rad.value) , 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromCtoD_rad.value)
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.value(i) = CL_Tail(obj1, ...
                                                        Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CLwb_pitch_contrib_fromCtoD.value(i), ...
                                                        Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CDwb_pitch_contrib_fromCtoD.value(i), ...
                                                        Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CTwb_pitch_contrib_fromCtoD.value(i), ...
                                                        Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CMwb_pitch_contrib_fromCtoD.value(i), ...
                                                        Aircraft.Geometry.Horizontal.l.value, ...
                                                        Aircraft.Geometry.Wing.mac.value, ...
                                                        Aircraft.Certification.Aerodynamic_data.XAC_nondim.value, ...
                                                        Aircraft.Certification.Aerodynamic_data.XCG_nondim.value, ...
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.Attributes.unit = "Non dimensional";
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.HTail_Lift_fromCtoD.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.value)   
    V = V_fromCtoD(i);
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.HTail_Lift_fromCtoD.value(i) = (0.5)*(V^2)* ... 
        (Aircraft.Geometry.Wing.S.value)*(Aircraft.Certification.ISA_Condition.rho.value)*(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.value(i))*(1E-1);   
end
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.HTail_Lift_fromCtoD.Attributes.unit = "daN";
% *************************************************************************
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.HTailAirloadsDiagram.value = Balancing_loads(obj, ...
                ...
                Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.HTail_Lift_fromCtoD.value, ...
                V_fromCtoD, ...
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD_new.value = ...
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD.value - Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_Tail_fromCtoD.value;
...
% *** From point C to point D ***
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WBLift_fromCtoD_new.value = zeros(length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD_new.value), 1);
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD_new.value)   
    V = V_fromCtoD(i);
    Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WBLift_fromCtoD_new.value(i) = (0.5)*(V^2)* ...
        (Aircraft.Geometry.Wing.S.value)*(Aircraft.Certification.ISA_Condition.rho.value)*(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromCtoD_new.value(i))*(1E-1);   
end
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WBLift_fromCtoD_new.Attributes.unit = "daN";
% *************************************************************************
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WingAirloadsDiagram.value = Mainwing_loads(obj, ...
                ...
                Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.Negative_stall_speed.value, ... 
                Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.WBLift_fromCtoD_new.value, ...
                V_fromCtoD, ...
