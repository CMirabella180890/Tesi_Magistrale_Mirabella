...
%         xlim([0.0 V_fromDto0(1)])
        ...
        text(V_fromA2toD(end), V_fromA2toD(end),   '  D',  'FontSize', 6)
        text(40.75, -18, 'n = 1')
        % ---------------------------------------------------------------------
...
switch (Inverted_flight_Case)
    ...
    case 'Case 2'
        ...
        % ---------------------------------------------------------------------
        text(V_from0toSinv(end),  LW_from0toSinv_new(end),  '\fontname{Courier} S inv.', 'FontSize', 6)
        text(V_fromSinvtoG1(end), LW_fromSinvtoG1_new(end), '\fontname{Courier} G1',     'FontSize', 6)
        text(V_fromG1toF(end),    LW_fromG1toF_new(end),    '\fontname{Courier} F',      'FontSize', 6)
        text(V_fromFtoE(end),     LW_fromFtoE_new(end),     '\fontname{Courier} E',      'FontSize', 6)        
end
% -------------------------------------------------------------------------
