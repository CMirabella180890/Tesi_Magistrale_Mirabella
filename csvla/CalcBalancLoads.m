...
Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value = c2; 
...
%         text(VA,               WBL_A,                  '  A',  'FontSize', 6)
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.CL_S.Attributes.unit = "Non dimensional"; 
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.CL_S_new.value = CL_from0toS_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA1.CL_A1.Attributes.unit = "Non dimensional";
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA1.CL_A1_new.value = CL_fromStoA1_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.CL_C.Attributes.unit = "Non dimensional";
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.CL_C_new.value = CL_fromA1toC_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA2.CL_A2_new.value = CL_fromCtoA2_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.CL_D.Attributes.unit = "Non dimensional"; 
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.CL_D_new.value = CL_fromA2toD_new(end);
...
%         text(VG,                  WBL_G,                    ' G',      'FontSize', 6)
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS_inv.CL_S_inv_new.value = CL_from0toSinv_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG1.CL_G1_new.value = CL_fromSinvtoG1_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointF.CL_F_new.value = CL_fromG1toF_new(end);
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.CL_E_new.value = CL_fromFtoE_new(end);
