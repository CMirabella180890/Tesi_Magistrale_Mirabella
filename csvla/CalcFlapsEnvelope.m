...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.VF.Attributes.unit = "meters per seconds";
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.VSpos_vec.Attributes.unit = "meters per seconds";
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.PointS.VS.Attributes.unit = "meters per seconds"; 
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.PointA.VA.Attributes.unit = "meters per seconds"; 
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.PointF.VF.Attributes.unit = "meters per seconds"; 
...
for i = 1:length(Solution)
    if Solution(i) > 0
        ...
        if abs(new_VA) > VA
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_from0toS.Attributes.unit = "meters per seconds"; 
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromStoA.Attributes.unit = "meters per seconds"; 
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromAtoF.Attributes.unit = "meters per seconds";
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromFto0.Attributes.unit = "meters per seconds"; 
        ...
        if abs(new_VA) < VA
            ...
            if abs(n_g_plus) > nmax 
                ...
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromAtoF1.Attributes.unit = "meters per seconds"; 
                ...
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromF1toF.Attributes.unit = "meters per seconds"; 
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.n_fromFto0.value            = n_fromFto0;
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.n_fromFto0.Attributes.unit  = "g's"; 
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromFto0.value            = V_fromFto0;
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Takeoff.final_envelope.V_fromFto0.Attributes.unit  = "meters per seconds"; 
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.VF.Attributes.unit = "meters per seconds";
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.VSpos_vec.Attributes.unit = "meters per seconds";

% EVALUATION OF STALL AND FLAP MANOEUVRING POINT 
% POINT S 
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.PointS.VS.value = VS1;
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.PointS.VS.Attributes.unit = "meters per seconds"; 
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.PointA.VA.Attributes.unit = "meters per seconds"; 
...
Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.PointF.VF.Attributes.unit = "meters per seconds"; 
...
for i = 1:length(Solution)
    if Solution(i) > 0
        ...
        if abs(new_VA) > VA
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_from0toS.Attributes.unit = "meters per seconds"; 
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromStoA.Attributes.unit = "meters per seconds"; 
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromAtoF.Attributes.unit = "meters per seconds";
            ...
            Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromFto0.Attributes.unit = "meters per seconds"; 
        ...
        if abs(new_VA) < VA
            ...
            if abs(n_g_plus) > nmax 
                ...
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromAtoF1.Attributes.unit = "meters per seconds"; 
                ...
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromF1toF.Attributes.unit = "meters per seconds"; 
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.n_fromFto0.value            = n_fromFto0;
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.n_fromFto0.Attributes.unit  = "g's"; 
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromFto0.value            = V_fromFto0;
                Aircraft.Certification.Regulation.SubpartC.Flapsloads.Landing.final_envelope.V_fromFto0.Attributes.unit  = "meters per seconds"; 
