...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.cm_S.Attributes.unit = "Non dimensional";
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    ...
                    Interpolated_Global_CM_A1(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA1.cm_A1.Attributes.unit = "Non dimensional";
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_C1(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_C1(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC1.cm_C1.Attributes.unit = "Non dimensional";
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_C(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_C(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.cm_C.Attributes.unit = "Non dimensional";
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_C2(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_C2(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC2.cm_C2.Attributes.unit = "Non dimensional";
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_D(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_D(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%         Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.cm_S.Attributes.unit = "Non dimensional";
        ...
        if exist('check_interp', 'var') == 1
            for i = 1:length(yi)
                Interpolated_Global_CD_A(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                Interpolated_Global_CM_A(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
switch (Inverted_flight_Case)
    ...
    case 'Case 1'
        ...
        Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.cl_at_CL1.Attributes.unit = "Non dimensional"; 
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_S_inv(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_S_inv(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS_inv.cm_S_inv.Attributes.unit = "Non dimensional";            
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_G(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_G(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG.cm_G.Attributes.unit = "Non dimensional";  
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_G1(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_G1(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG1.cm_G1.Attributes.unit = "Non dimensional";      
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_F(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_F(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointF.cm_F.Attributes.unit = "Non dimensional";  
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_G2(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_G2(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
...
%             Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG2.cm_G2.Attributes.unit = "Non dimensional";        
            ...
            if exist('check_interp', 'var') == 1
                for i = 1:length(yi)
                    Interpolated_Global_CD_E(i) = k_cd * trapz(half_span, cd_interpolated(:,i).*chord_distribution);
                    Interpolated_Global_CM_E(i) = k_cm * trapz(half_span, cm_interpolated(:,i).*chord_distribution);
