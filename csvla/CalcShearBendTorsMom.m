...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.VS.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.Positive_stall_speed.value(1);
...
% Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.CL_S.value = CL_calc(obj1, ...
...
%                                               Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.VS.value, ...
%                                               Aircraft.Certification.ISA_Condition.rho0.value, ...
%                                               Aircraft.Geometry.Wing.S.value);
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.CL_S.value = Aircraft.Certification.Aerodynamic_data.Max_Lift_Coefficient.value; 
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA.CL_A.value = Aircraft.Certification.Aerodynamic_data.Max_Lift_Coefficient.value; 
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.CL_C.value = Aircraft.Certification.Aerodynamic_data.Max_Lift_Coefficient.value;  
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.VD_unit_load_factor.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.V_unit_load_factor.value(end);
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.VD_unit_load_factor.Attributes.unit = "m/s";
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.CL_D.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromDtoE.value(1); 
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointF.VF.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.Negative_stall_speed.value(end);
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointF.CL_F.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromFtoE.value(1);
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG.CL_G.value = Aircraft.Certification.Aerodynamic_data.Min_Lift_Coefficient.value;
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.VE.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Gustloads.Airspeed_dive.value(end);
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.nE.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.Man_load_factor_nE.value;
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.nE.Attributes.unit = "g"; 
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.CL_E.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.CL_fromFtoE.value(end);
...
Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.alpha_E.value = alpha_calc(obj1, ...
                                       ...
                                       Aircraft.Certification.Aerodynamic_data.Normal_Force_Curve_Slope_deg.value, ...
                                       p);
% Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.alpha_E.value = Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.alpha_fromDtoE_new.value(end) - Aircraft.Certification.Aerodynamic_data.Alpha_zero_lift.value; 
...
CL_S = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.alpha_S.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointS.alpha_S.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
CL_A = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA.alpha_A.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointA.alpha_A.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
CL_C = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.alpha_C.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointC.alpha_C.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
CL_D = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.alpha_D.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointD.alpha_D.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
CL_F = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointF.alpha_F.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointF.alpha_F.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
CL_G = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG.alpha_G.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointG.alpha_G.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
CL_E = Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_a.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.alpha_E.value^2 + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_b.value*Aircraft.Certification.Regulation.SubpartC.Flightloads.Final_envelope.PointE.alpha_E.value + Aircraft.Certification.Aerodynamic_data.Alpha_PolCoeff_c.value;
...
for i = 1:length(Aircraft.Certification.Regulation.SubpartC.Flightloads.Balancingloads.cl_interpolated.value(1,:))
    ...
    if (global_CL(i) >= 1.0-1e-3) && (global_CL(i) <= 1.0+1e-3)
