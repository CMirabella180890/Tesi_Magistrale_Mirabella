...
if InputSource == "From File"
    ...
    Aircraft.Certification.Aerodynamic_data.CL_fullmodel.Attributes.unit      = "Non dimensional";
    Aircraft.Certification.Aerodynamic_data.CL_max.value = max(Aircraft.Certification.Aerodynamic_data.CL_fullmodel.value);
    ...
    % -------------------------------------------------------------------------    
    clear CL_wb CD_wb CM_wb alpha_wb alpha_interp
